...
Our project is related to a specic learning disability in children, Dyslexia. First,
we need to know what is Dyslexia. Dyslexia is a specic learning disability in
reading. Kids with Dyslexia have trouble reading accurately and 
uently. They
may also have trouble with reading comprehension, spelling and writing. It is a
lifelong condition that makes it dicult for people to read. Its the most common
...
uently. Kids with
Dyslexia may have trouble answering questions about something they have read.
But when its read to them, they may have no diculty at all. Dyslexia impacts
people in varying degrees, so symptoms may dier from one child to another.
Generally, symptoms show up as problems with accuracy and 
uency in reading
and spelling.
...
uently. One reason kids have diculty decoding is that they often struggle with
...
intelligent enough to lter out the words with which the child is facing more
diculty and use these words more frequently in subsequent phases, in order to
make the child get comfortable with that word, thus overcoming the diculty.
The app has n levels of diculty, say 1, 2, 3,., n where level 1 contains words
and the associated sentences of least diculty ( simple words and sentences). As
the level increases, the user will be given more dicult words (in the sense, which
are lengthy or dicult to pronounce or relatively newer words) and sentences. If
...
free, which is not aordable by all. And there are very few apps which focus on
combating the challenges faced by children suering from Dyslexia. Keeping these
two things in mind, our focus was clear - to develop an interactive learning app
(Android) for children suering from Dyslexia, which is free of cost. Apart from the
...
and feasible. Smart-phones are cheaper and more cost ecient nowadays, thus
